"""Convierte el design doc markdown a .docx para subir a Gemini."""
import re
from docx import Document
from docx.shared import Pt, RGBColor

src = open("docs/DESIGN_ingesta_visual_pgvector.md", encoding="utf-8").read()
doc = Document()
...
out = r"C:\Users\DETPC\Desktop\Contexxto\DISENO_Ingesta_Visual_pgvector.docx"
doc.save(out)
print("OK ->", out)
