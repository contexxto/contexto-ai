...
import { X, Upload, Check, Trash2, Loader, Pencil, AlertTriangle } from 'lucide-react'
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        {loading ? (
          ...
          <form onSubmit={guardar}>
            ...
            {error && <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: C.coral, fontSize: '.82rem', marginTop: 14 }}><AlertTriangle size={14} /> {error}</div>}
            ...
            {editando ? (
              ...
              <button type="button" onClick={() => setEditando(true)}
                style={{ width: '100%', marginTop: 20, padding: '13px', borderRadius: 12, cursor: 'pointer',
                         ...
                         fontWeight: 800, fontSize: '.92rem', display: 'inline-flex',
