...
src = open("docs/BRAND_Contexto_AI.md", encoding="utf-8").read()
doc = Document()
...
for out in [r"C:\Users\DETPC\Desktop\Contexxto\BRAND_Contexto_AI.docx",
            r"C:\Users\DETPC\Desktop\Contexto-AI\docs\BRAND_Contexto_AI.docx"]:
    doc.save(out)
    print("OK ->", out)
