"""Convierte el design doc de Fase B a .docx para Gemini."""
import re
from docx import Document
from docx.shared import Pt, RGBColor

src = open("docs/DESIGN_faseB_vision_embeddings.md", encoding="utf-8").read()
doc = Document()
...
for out in [r"C:\Users\DETPC\Desktop\Contexxto\DISENO_FaseB_Vision_Embeddings.docx",
            r"C:\Users\DETPC\Desktop\Contexto-AI\docs\DISENO_FaseB_Vision_Embeddings.docx"]:
    doc.save(out)
    print("OK ->", out)
