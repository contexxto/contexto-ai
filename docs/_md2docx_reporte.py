"""Convierte el Reporte de Fase B Completa a .docx para Gemini."""
import re
from docx import Document
from docx.shared import Pt, RGBColor

src = open("docs/REPORTE_FaseB_Completa.md", encoding="utf-8").read()
doc = Document()
...
for ln in lines:
    ...
    if s.startswith("# "):
        ...
        p = doc.add_paragraph(strip_md(s.lstrip("> ").strip()))
...
for out in [r"C:\Users\DETPC\Desktop\Contexxto\REPORTE_FaseB_Completa.docx",
            r"C:\Users\DETPC\Desktop\Contexto-AI\docs\REPORTE_FaseB_Completa.docx"]:
    doc.save(out)
    print("OK ->", out)
